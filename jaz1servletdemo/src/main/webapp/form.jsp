...
<jsp:useBean id="inform" class="jaz1servletdemo.source.Info" scope="session" />
	...
	<form action="addPerson.jsp" method="get">
		...
		Skąd dowiedziałeś się o konferencji:<br><br>
			Ogłoszenie w pracy<input type="checkbox" name="inf1" value="Ogłoszenie w pracy"><br>
			Ogłoszenie na uczelni<input type="checkbox" name="inf2" value="Ogłoszenie na uczelni"><br>
			Facebook<input type="checkbox" name="inf3" value="Facebook"><br>
			Znajomi<input type="checkbox" name="inf4" value="Znajomi"><br>
			Inne (jakie?) <input type="text" name="inf5"><br><br>
